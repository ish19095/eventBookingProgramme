            ...
            <div class="col-lg-6">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <ul style="list-style-type:none" required>
                        ...
                        <select id="internal_event_site" name="internal_event_site" class="form-select" required>
                        ...
                        <select id="internal_event_type" name="internal_event_type" class="form-select" required>
                        ...
                        <select id="internal_event_dept" name="internal_event_dept" class="form-select" required>
                        ...
                        <select id="internal_event_staff_member" name="internal_event_staff_member" class="form-select" required>
                        ...
                        <select id="internal_event_other_member" name="internal_event_other_member" class="form-select" required>
                            <option value="" disabled selected>--Choose Staff Member--</option>
            ...
            <div class="col-lg-6">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <input type="text" class="form-control date" id="external_event_date" data-toggle="date-picker" data-cancel-class="btn-warning" required>
                        <br>
                        <!-- Time -->
                        ...
                        <select id="external_event_site" name="external_event_site" class="form-select" required>
                        ...
                        <input type="checkbox" id="external_event_BLM" class="form-check-input" required></input>
                        <br>      
                        <!-- Type   -->
                        <label for="external_event_type" class="form-label">Event Type:</label>
                        <select id="external_event_type" name="external_event_type" class="form-select" required>
                        ...
                        <input data-toggle="touchspin" id="external_expected_participants" name="external_expected_participants" type="text" value="0" required>
                        <br>
                        ...
                        <select id="external_event_dept" name="external_event_main_dept" class="form-select" required>
                            <option value="" disabled selected>--Choose Department--</option>
                        ...
                        <select id="external_event_dept" name="external_event_sec_dept" class="form-select" required>
                            <option value="" disabled selected>--Choose Department--</option>
                            <option value="dp1">Dept 1</option>
                            <option value="dp2">Dept 2</option>
                            <option value="dp3">Dept 3</option>
                        ...
                        <select id="external_event_dept" name="external_event_third_dept" class="form-select" required>
                            <option value="" disabled selected>--Choose Department--</option>
                            <option value="dp1">Dept 1</option>
                            <option value="dp2">Dept 2</option>
                            <option value="dp3">Dept 3</option>
                        ...
                        <input type="checkbox" id="external_event_fee" checked data-switch="success" required/>
            ...
            <div class="col-lg-6">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <input type="text" id="external_event_company_name" class="form-control" required>

                        <label for="external_event_contact_person" class="form-label">Contact Person:</label>
                        <input type="text" id="external_event_contact_person" class="form-control" required>

                        <label for="external_event_contact_email" class="form-label">Contact Email:</label>
                        <input type="text" id="external_event_contact_email" class="form-control" required>

                        <label for="external_event_contact_number" class="form-label">Contact Number:</label>
                        <input type="text" id="external_event_contact_number" class="form-control" required>

                        <label for="external_event_vat" class="form-label">VAT Number:</label>
                        <input type="text" id="external_event_vat" class="form-control" required>
            ...
            <div class="col-lg-6">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <input type="text" id="external_event_payment_amount" class="form-control" required>                        
                        <br>
                        <label class="form-label">Payment Confirmed:</label>
                        <input type="checkbox" id="external_event_payment" checked data-switch="success" required/>
                        ...
                        <input data-toggle="touchspin" id="external_actual_participants" name="external_actual_participants" type="text" value="0" required>
                        <br>
                        <label class="form-label" for="external_blm_members">Number of BLM members attending:</label>
                        <input data-toggle="touchspin" id="external_blm_members" name="external_blm_members" type="text" value="0" required>
                        <br>
                        <label for="external_event_income" class="form-label">Income:</label>
                        <input type="text" id="external_event_income" class="form-control" required> 
                        <br>
                        <label class="form-label">Sales:</label>
                        <input type="checkbox" id="external_event_sales" checked data-switch="success" required/>
                        <label for="external_event_sales" data-on-label="Yes" data-off-label="No"></label>
                        <br>
                        <label class="form-label">Membership:</label>
                        <input type="checkbox" id="external_event_member" checked data-switch="success" required/>
