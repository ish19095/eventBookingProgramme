            ...
            <div class="col-lg-6">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <label class="form-label">Type of Participants:</label>
                        <ul style="list-style-type:none">
                        ...
                        <label class="form-label">Other persons required for the running of the event:</label>
                        <ul style="list-style-type:none">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ishma\Desktop\Code\tempProject\resources\views/events/create.blade.php ENDPATH**/ ?>