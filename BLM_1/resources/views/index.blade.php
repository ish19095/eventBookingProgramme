...
<head>
    ...
    {{-- <link href="{{ URL::asset('css/app-creative.min.css');}}" rel="stylesheet" type="text/css" id="light-style" /> --}}
       

    <link href="assets/css/app-creative-dark.min.css" rel="stylesheet" type="text/css" id="dark-style" />    
    {{-- <link href="{{ URL::asset('css/app-creative-dark.min.css');}}" rel="stylesheet" type="text/css" id="dark-style" /> --}}
    {{-- <link href="{{ HTML::style('css/app-creative-dark.min.css'); }}" rel="stylesheet" type="text/css" id="dark-style" />    --}}
