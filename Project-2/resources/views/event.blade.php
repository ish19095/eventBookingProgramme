...
<div class="tab-content">
    ...
    <form id="internal_form">
            ...
            <ul style="list-style-type:none">
                ...
                <li class="form-check-label" ><input type="checkbox" class="form-check-input">  All Day</li>
            </ul>
            <br>
            <!-- Site -->
    ...
    <div class="tab-pane show active" id="external_content">
        <form>
            ...
            <br>
            <!-- BLM Event -->
            <label class="form-label">BLM Event:</label>
            <input type="checkbox" id="external_event_BLM" class="form-check-label"></input>
            <br>      
            <!-- Type   -->
